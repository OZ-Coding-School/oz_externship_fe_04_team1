...
// 하위 컴포넌트로
// -  BasicInfoSection(이름, 닉네임, 생년월일, 성별)
// - EmailVerificationSection(이메일 인증)
// - PhoneVerificationSection(휴대폰 인증)
...
function SignupPage() {
  return (
    ...
    <div className="mx-auto flex min-h-screen w-full flex-col items-center bg-gray-50">
      {/* 회원가입 폼 */}
      <form className="my-14 flex h-[1287px] w-[528px] flex-col gap-9 bg-white px-5 py-10">
        {/* 헤더 */}
