...
function CourseBookmark({
  ...
  return (
    <div className="flex h-[158px] w-[318px] gap-3 rounded-xl border border-gray-200 p-[13px] md:w-[838px] md:items-center md:gap-6 md:p-[25px]">
      {/* thumbnail */}
      <img
      ...
      <div className="flex flex-1 flex-col md:flex-row md:items-start">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 pb-2 md:gap-3 md:pb-0">
            <span
              className={`${PLATFORM_STYLES[platform]} ${BADGE_BASE_CLASS}`}
            >
